...
if _snakemake:
    _ppa_maintenance = snakemake.params[0] # ATP mmol/gDW/h
...
title = f'Experimental vs simulated growth rates on glucose\nunder different oxygen conditions for P. pastoris\n{_condition_name}'
y_label = 'Growth rate [1/h]'
outpath = ""
if _plotting:
    outpath = snakemake.output[0]
hf.plot_multiple_conditions(_growth_conditions, _condition_names, title, y_label, outpath, min_value = 0.05, max_value = 0.15, show_plot=False)


# plot experimental vs simulated co2 production
title = f'Experimental vs simulated CO2 production on glucose\nunder different oxygen conditions for P. pastoris\n{_condition_name}'
...
hf.plot_multiple_conditions(_co2_productions, _condition_names, title, y_label, outpath, min_value = 0, max_value = 3.75, show_plot=False)